...
@section('meta')
    ...
    <title>E-learning - Add Teacher</title>
@stop
    ...
    <div class="row">
      <div class="col-md-offset-1 col-md-10">
        ...
        <div class="box box-primary">
          ...
          <!-- form start -->
          {!! Form::open(['url' => route('admin.teachers.store'), 'autocomplete' => 'off', 'id' => 'teacher-form']) !!}
            @include('forms.teacher', ['button' => 'Add Teacher', 'flag' => false])
