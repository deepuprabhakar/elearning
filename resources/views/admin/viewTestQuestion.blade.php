      ...
      <div class="col-md-12">
        <div class="box box-success box-solid">
          <div class="box-header with-border">
            <h3 class="box-title">List of Test Questions</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
              ...
              @foreach ($questions as $key => $question)
                <tr>
                  ...
                  <td class="text-center table-actions">
                    <a class="btn bg-olive btn-xs btn-flat" href="{{ route('admin.test.editquestion', $question['slug']) }}" style="margin: 0 3px 0 2px;">Edit</a>
                    {!! Form::open(['route' => ['admin.test.deletequestion', $question['hashid']], 'method' => 'DELETE', 'class' => 'delete-form']) !!}
