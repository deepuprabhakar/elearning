...
class PasswordController extends Controller
{
    ...
    public function postRequest(Request $request)
    {
        ...
        if(!$user)
            return redirect()->back()->with('error', "User doesn't exist in our records!");
        ...
        $message = 'Instructions for changing your password has been sent to your email address if it is associated with a valid account.';
